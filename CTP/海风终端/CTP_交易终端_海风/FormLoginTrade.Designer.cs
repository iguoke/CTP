namespace CTP_交易终端_海风
{
	partial class FormLoginTrade
	{
		...
		private void InitializeComponent()
		{
			...
			CTP_交易终端_海风.Properties.Settings settings1 = new CTP_交易终端_海风.Properties.Settings();
			...
			// savePWDCheckBox
			// 
			settings1.CustomVolume = null;
			settings1.FastCloseAddTick = false;
			settings1.FastCloseTick = new decimal(new int[] {
            1,
            0,
            0,
            0});
			settings1.FlowPriceAddTick = false;
			settings1.FlowPriceTick = new decimal(new int[] {
            1,
            0,
            0,
            0});
			settings1.FormLocation = new System.Drawing.Point(0, 0);
			settings1.FormSize = new System.Drawing.Size(1100, 600);
			settings1.Instruments = null;
			settings1.KeepInstrument = true;
			settings1.KeepLots = false;
			settings1.Log = null;
			settings1.PlaySound = true;
			settings1.SavePWD = true;
			settings1.ServerIndex = 0;
			settings1.Servers = null;
			settings1.SettingsKey = "";
			settings1.ShowTootip = true;
			settings1.TopHeigh = 255;
			settings1.TopVisable = true;
			this.savePWDCheckBox.Checked = settings1.SavePWD;
			this.savePWDCheckBox.CheckState = System.Windows.Forms.CheckState.Checked;
			this.savePWDCheckBox.DataBindings.Add(new System.Windows.Forms.Binding("Checked", settings1, "SavePWD", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
